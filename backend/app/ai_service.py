    ...
    try:
        ...
        try:
            ...
            if docs:
                ...
                # If no docs and LLM failed, return a friendly message without exposing internals
                return "Our AI assistant is experiencing high demand. Please try again in a moment, or contact the front desk for assistance."
        ...
        import traceback
        traceback.print_exc()
        return "Our AI assistant is currently unavailable. Please try again or contact the front desk for assistance."
